...
class PTMTokenizer(Tokenizer):
    def __init__(self):
        ...
        self.ptm_to_aa = {
            ...
            "Z": "Z",
            "O": "O",
            "<N-linked (GlcNAc...) asparagine>": "N",
            "<Pyrrolidone carboxylic acid>": "Q",
            "<Phosphoserine>": "S",
            "<Phosphothreonine>": "T",
            "<N-acetylalanine>": "A",
            "<N-acetylmethionine>": "M",
            "<N6-acetyllysine>": "K",
            "<Phosphotyrosine>": "Y",
            "<S-diacylglycerol cysteine>": "C",
            "<N6-(pyridoxal phosphate)lysine>": "K",
            "<N-acetylserine>": "S",
            "<N6-carboxylysine>": "K",
            "<N6-succinyllysine>": "K",
            "<S-palmitoyl cysteine>": "C",
            "<O-(pantetheine 4'-phosphoryl)serine>": "S",
            "<Sulfotyrosine>": "Y",
            "<O-linked (GalNAc...) threonine>": "T",
            "<Omega-N-methylarginine>": "R",
            "<N-myristoyl glycine>": "G",
            "<4-hydroxyproline>": "P",
            "<Asymmetric dimethylarginine>": "R",
            "<N5-methylglutamine>": "Q",
            "<4-aspartylphosphate>": "D",
            "<S-geranylgeranyl cysteine>": "C",
            "<4-carboxyglutamate>": "E"
        }
    ...
    def convert_tokens_to_sequence(self, ids):
        aa_list = [self.ptm_to_aa[self.ids_to_tokens[i]] for i in ids]
        return "".join(aa_list), [aa!='' for aa in aa_list]
