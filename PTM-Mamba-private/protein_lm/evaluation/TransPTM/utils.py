...
def get_f1(y_true, y_pred):
    y_pred_binary = (y_pred >= 0.5).astype(int)  # Assuming threshold of 0.5, you can adjust as needed
...
class TrainProcessor:
    ...
    def test(self, model, dataloader):
        ...
        metrics['f1'] = get_f1(y, pred)
        # use sklearn.metrics to calculate mcc auc
        metrics['mcc'] = matthews_corrcoef(y, pred.round())
        metrics['precision'] = precision_score(y, pred.round())
        metrics['recall'] = recall_score(y, pred.round())
