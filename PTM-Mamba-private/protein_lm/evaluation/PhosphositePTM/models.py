...
class MambaClassificationModel(pl.LightningModule):
    def __init__(self, ckpt_path="../../ckpt/bi_mamba-esm-ptm_token_input/best.ckpt"):
    ...
    def common_step(self, batch, batch_idx):
        ...
        # return both probabilities and outputs 
    ...
    def training_step(self, batch, batch_idx):
        ...
        auroc = AUROC("binary")(probabilities[:, 1].cpu(), labels.cpu())
...
class ESM3BClassificationModel(MambaClassificationModel):
    def __init__(self):
        super(ESM3BClassificationModel, self).__init__()
...
class ESM650MClassificationModel(MambaClassificationModel):
    def __init__(self):
        super(ESM650MClassificationModel, self).__init__()
        self.esm_model, self.alphabet = esm.pretrained.esm2_t33_650M_UR50D()
        self.batch_converter = self.alphabet.get_batch_converter()
        self.esm_model.eval()
        for param in self.esm_model.parameters():
            param.requires_grad = False
        self.mlp = ClassificationHead(1280, 2)
        self.embedding = self._compute_embedding
