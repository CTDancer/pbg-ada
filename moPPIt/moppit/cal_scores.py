...
# base_path = "/home/tc415/muPPIt/muppit/pdb_results/OTUD3/PVDFDLLS" # where you want to pull files from 
...
def calculate_scores(base_path, pae_cutoff=12):
    '''
    ...
    saving_base_path = f"/home/tc415/moPPIt/moppit/fold_test_results"
