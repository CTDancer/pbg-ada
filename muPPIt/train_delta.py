...
class muPPIt(pl.LightningModule):
    ...
    def forward(self, binder_tokens, wt_tokens, mut_tokens):
        ...
        # pdb.set_trace()
        delta_pred = self.delta_mapping(delta_edges)
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss = self.criterion(delta_pred, delta)    # make sure it's the right loss function
    ...
    def validation_step(self, batch, batch_idx):
        ...
        # pdb.set_trace()
        accuracy = (delta_pred.round() == delta.round()).sum().item() / delta.shape[0]
    ...
    def load_weights(self, checkpoint_path):
        ...
        # nn.init.kaiming_uniform_(self.delta_mapping.weight)
        # self.delta_mapping.weight.data *= 0.001
        # if self.mapping.bias is not None:
        #     nn.init.zeros_(self.delta_mapping.bias)
